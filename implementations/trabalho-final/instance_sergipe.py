...
def instance():
  ...
  edge_nossa_senhora_da_gloria_orto_da_folha = Edge(vertex_nossa_senhora_da_gloria, vertex_porto_da_folha ,56.6)

  graph_citys_sergipe.add_edge(edge_nossa_senhora_da_gloria_orto_da_folha)